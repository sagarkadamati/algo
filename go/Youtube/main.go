...
func main() {
	...
	y := NewYoutube(true)
	y.DecodeURL("https://www.youtube.com/watch?v=Np28O3Y_P2o")

	targetStream := y.StreamList[0]
	title := targetStream["title"]
	vtype  := targetStream["type"]

	println("\nTITLE:" + title)
	println("\nVTYPE:" + vtype)
	println("\n")

	y.StartDownload(title + ".mp4")
}

// $env:PATH += ";C:\Users\Sagar\Workspace\Tools\Git\bin"
// $env:PATH += ";C:\Users\Sagar\Workspace\Tools\go\bin"
// $env:PATH += ";C:\Users\Sagar\Workspace\Tools\kotlinc\bin"
// $env:PATH += ";C:\Users\Sagar\Workspace\Tools\VS Code\bin"
// $env:PATH += ";C:\Users\Sagar\Workspace\Tools\Python"