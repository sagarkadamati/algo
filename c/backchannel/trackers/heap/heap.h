...
#define BC_HEAP_STATUS_STREAM_SIZE			(BC_HEAP_STATUS_STREAM_OBJ_SIZE *		\
												BC_HEAP_STATUS_STREAM_OBJ_COUNT)

#define BC_HEAP_BLOCKS_STREAM_OBJ_SIZE		sizeof(heap_block)
#define BC_HEAP_BLOCKS_STREAM_OBJ_COUNT		10000
#define BC_HEAP_BLOCKS_STREAM_SIZE			(BC_HEAP_BLOCKS_STREAM_OBJ_SIZE *		\
												BC_HEAP_BLOCKS_STREAM_OBJ_COUNT)

#define HEAP_TRACKER_NAME					"Heap"
#define HEAP_TRACKER_SIZE					(BC_HEAP_STATUS_STREAM_SIZE + 			\
											 BC_HEAP_BLOCKS_STREAM_SIZE +			\
											 STREAM_SIZE(BC_HEAP_STREAM_COUNT))
